...
// ### Baut eine eigene "WLAN-WEB-CAM" auf und startet unter http://192.168.4.1 ein Webinterface
...
void serverLoop() {
  while (true) {
    delay(1000);
    Serial.println("Der WiFi Manager ist aktiv ... 192.168.4.1");
  }
}
